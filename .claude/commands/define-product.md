...
!`test -f product.md && echo "⚠️ product.md already exists" || echo "✓ Creating new product.md"`
...
6. **Generate product.md** - Use template at @.claude/templates/product.md
7. **Validate** - Ensure NO technical decisions, only user needs

**Critical**: product.md must be PURELY user-centric with NO tech stack, architecture, or implementation details.

---

## Next Step

After creating product.md, run `/generate-constitution` to derive technical principles FROM these user needs.
